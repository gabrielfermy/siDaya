...
> **Evaluation Timestamp**: Sun, 20 Sep 2026 04:31:51 GMT  
...
> **Report Artifact**: `reports/security/vapt-report-2026-09-20_04-31-51.md`
...
| **Test Vectors Evaluated** | **14 Invariants** | 100% Executed |
| **Passed Invariants** | **14 / 14** | **100% Pass Rate** |
...
| **SEC-PAY-05** | PAYMENT_INTEGRITY | OWASP API2:2023 (Broken Authentication) & PCI-DSS Section 6.5 | iPaymu API v2 HMAC-SHA256 Webhook Signature Verification & Normalization | ✅ PASSED | CRITICAL |
...
### [SEC-PAY-05] iPaymu API v2 HMAC-SHA256 Webhook Signature Verification & Normalization
* **Category**: `PAYMENT_INTEGRITY` | **Severity**: `CRITICAL`
* **Standard Mapping**: *OWASP API2:2023 (Broken Authentication) & PCI-DSS Section 6.5*
...
* **Adversarial Payload**: `POST webhook with forged X-Signature header`
* **Observed Result**: Forged signature rejected (false); authentic HMAC-SHA256 verified (true); status canonicalized to SETTLED.
* **Status**: **PASSED**
...
* **Observed Result**: Subscription invoice SUB-BERASJAYA-711378 settled independently.
* **Status**: **PASSED**
